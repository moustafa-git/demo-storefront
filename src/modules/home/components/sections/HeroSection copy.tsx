...
const HeroSection = ({ isPreloading }) => {
  ...
  return (
    <section className="bg-main-bg">
      <div className="hero-container relative bg-[#fafafa] w-screen h-dvh overflow-hidden">
        {isTablet ? (
          <>
            {isMobile && (
              <img
        ...
        <div className="hero-content relative z-10 w-full h-full flex flex-col 2xl:justify-center items-center translate-y-10 2xl:pt-0 md:pt-32 pt-24 opacity-0">
          <div className="overflow-hidden">
            <h1 className="hero-title text-dark-brown  md:text-[6.5rem] text-[3.3rem] font-bold uppercase leading-[9vw] tracking-[-.35vw] 2xl:mb-0 mb-5 text-[#212121]">
          ...
          >
            <div className="hero-subtitle bg-[rgba(232,226,208,0.5)] shadow-lg">
              <h1 className="uppercase  md:text-[6.5rem] text-[3.3rem] font-bold text-[#212121] leading-[9vw] tracking-[-.35vw] 2xl:px-[1.2vw] px-3 2xl:pb-[1vw] pb-5 2xl:py-0 py-3">
          ...
          <p
            className="
    hero-paragraph md:text-[#52525B] text-[#212121] absolute bottom-[130px] font-paragraph text-center text-lg max-w-2xl md:mt-15 leading-[115%]
  "
          >
          ...
          <div className="mt-30 md:mt-0 absolute bottom-12">
